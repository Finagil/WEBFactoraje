...
<td align=center> 
    ...
    <asp:ObjectDataSource ID="Lotes_DS" runat="server"
        OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByTodos" TypeName="WebProspectos.Factor100DSTableAdapters.WEB_LotesAuxTableAdapter">
