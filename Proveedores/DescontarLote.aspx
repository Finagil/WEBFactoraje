<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMasterDefault.Master" CodeBehind="DescontarLote.aspx.vb" Inherits="WebProspectos.DescontarLote" 
    title="Facturas por Descontar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="#f58220"
        Text="Lotes Pendietes de Descontar"></asp:Label>
                <br />
                <br />
    <asp:GridView ID="GridView2" runat="server"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="Id_Lote" DataNavigateUrlFormatString="DescontarLote.aspx?ID={0}"
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="Original_Id_Lote" Type="Decimal" />
                ...
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="#f58220"
                    Text="Facturas para Descontar"></asp:Label><br />
                <br />
                ...
                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="#f58220"
                    Text="totalFAC" Visible="False"></asp:Label>
                <br />
        <cc1:botonenviar id="BotonEnviar2" runat="server" text="Descontar" textoenviando="Descontando..."
            width="97px" Visible="False"></cc1:botonenviar>
                <br />
                <br />
            </td>
        </tr>
